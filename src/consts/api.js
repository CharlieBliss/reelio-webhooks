...
export const jiraRegex = /((XYZ|FRONT|BACK|RA|FAT)-\d+)/gi
export const jiraRegexWithDescription = /((XYZ|FRONT|BACK|RA|FAT)-\d+)(.*)/gi
export const deployRegex = /((XYZ|FRONT|BACK|RA|FAT)-\d+)\s::\s(.+?(?=]))/
