export const qaToDone = {
	...
	"issue": {
		...
		"fields": {
			...
			"customfield_10900": "|| Deployed On || PR API || PR Human || Deployed || QA Approved || \n || 3/31/2017 || [(internal use)|https://api.github.com/repos/Kyle-Mendes/public-repo/pulls/26] || [26|https://github.com/Kyle-Mendes/public-repo/pull/26] || [Yes|http://zzz-xyz1.s3-website-us-east-1.amazonaws.com/] || ||",
